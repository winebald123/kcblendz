...
This codebase was built as a five-person team sprint. See `docs/TRELLO_BOARD.md` for the full sprint plan and `docs/GITHUB_COMMITS.md` for the 125-commit history split across the team.

| Member | Role | Owns |
|--------|------|------|
| Member 1 | Public UI lead | Public templates, brand system, region picker, footer, navigation |
| Member 2 | Builder & motion | Custom smoothie builder, animations, video integration, live pricing |
| Member 3 | Backend & database | Flask routes, SQLite schema, seeds, API, payment validation |
| Member 4 | Customer dashboard | Authentication, account pages, favorites, reviews |
| Member 5 | Admin & CMS | Admin panel, blog CMS, reports, admin profile, deployment |
